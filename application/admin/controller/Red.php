...
{ 
    ...
    public function list()
    {
        ...
        return $this -> fetch('red/red-list');
    }
    ...
    public function save()
    {
        ...
        if($result===true){
            ...
            $res = $userId = Db::name('red')->insertGetId($data_save);
    ...
    {
        $id = intval(input('id'));
        $data_info = Db::name('red')
            ->where('id',$id)
            ->find();

        $this -> assign('data',$data_info);
        return $this -> fetch('red/red-edit');
    }
